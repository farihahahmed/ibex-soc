...
are md5-identical to the PDK's. An independent KLayout DRC of the foundry deck run directly on the GDS reports zero violations, confirming these are LEF-abstract artifacts, not real geometry. They are macro-internal, not routing-induced,
...
synthesized PicoRV32. `docs/FRONTEND_SYNTHESIS.md` covers the synthesis results.
