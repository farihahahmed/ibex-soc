//      // verilator_coverage annotation
 ...
 103918     input  logic        PCLK,          // APB clock (same system clock).
 000039     input  logic        PRESETn,       // APB reset, active-low.
        
            // ---- APB slave interface (the bridge drives these) ----
%000002     input  logic        PSEL,          // selected.
%000006     input  logic        PENABLE,       // 0 = setup, 1 = access.
%000001     input  logic        PWRITE,        // write vs read.
%000002     input  logic [31:0] PADDR,         // address (I have few registers, mostly ignore it).
%000002     input  logic [31:0] PWDATA,        // write data.
%000000     output logic [31:0] PRDATA,        // read data.
%000001     output logic        PREADY,        // I'm done. Always 1 (GPIO is fast).
...
%000002     logic        gpio_sel;
%000002     logic        gpio_we;
%000000     logic [31:0] gpio_rdata;
